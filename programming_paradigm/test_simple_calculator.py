...
class test_Simplecalculator(unitest.TestCase)
    ...
    def test_multiply(self):
        self.assertEqual( SimpleCalculator.add(10,5),150)
        self.assertEqual( SimpleCalculator.add(10,0),0)
        self.assertEqual( SimpleCalculator.add(0,0),0)

    def test_divide(self):
        self.assertEqual( SimpleCalculator.add(10,5),2)
        self.assertEqual( SimpleCalculator.add(10,10),1)
        self.assertEqual( SimpleCalculator.add(10,5),"None")
